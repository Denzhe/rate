...
<nav class="white navHeaderPosition" role="navigation">
   ...
   if(!isset($_GET["admin"])) {
       echo('
        <ul  class="right hide-on-med-and-down"  style=" margin-top: 1%;">
                 <li>  
    
    <form method="get" action="/search" id="search">
  <input name="everythingName" type="text" size="40" placeholder="Search..." />
</form>
...
<div class="fixed-action-btn horizontal notificationClass " >
  <?php  if(($_SESSION['notification'])>0){  echo(' 
    <div class=" horizontal  " >
        <a class="btn-floating  white notificationalert">
            <span style="color:red;">'.$_SESSION['notification'].'*</span>
        </a>
    </div>');} ?>
    <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons"><img src="<?php echo(''.Url::templatePath().'image/notification.png');?>" style="width:50px;"  ></i></a
</div>
