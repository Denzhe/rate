...
use Core\Controller;
class AuthTwitter extends Controller
{
    ...
    {     
        $this->consumer_key = 'Z64NZO0fiamMZ4ONHEKXSuEVs';
        $this->consumer_secret = 'AkJ8VRw8OSSqEkEkJtcTGajOrqkbynEFwlzzy8GDWh25KOVhoi';
        $this->oauth_access_token = '306875739-UkD6FGzIR20n9povsPYjAi7ASItM1j1MgFhmsirf';
        $this->oauth_access_token_secret = 'q9bYqln74NHnJQHV3qnHqzLYQib0nI4yvOHmHi0PlUjQ2';
    }
	...
	public function  ReuturnbarearTokken(){
	...
	private function getBearerToken()
	{
		...
		else
		{
			...
			{
			echo("Error obtaining bearer token.  Missing nodes in response object.");
			}
		}
		curl_close($ch);		
	}	
